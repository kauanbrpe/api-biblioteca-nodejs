/**
    * HTTP Status Codes
    * Referência completa organizada por categoria.
     * Uso: import { HttpStatus } from '../utils/httpStatus';
...
*/
    ...
    /**
     * Mensagens padrão associadas a cada status code.
     * Útil para respostas de erro padronizadas.
     */
